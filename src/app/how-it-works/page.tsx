  ...
  return (
    <main className="min-h-screen bg-cream text-ink-warm">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 sm:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(78,93,67,0.06),transparent)]" />
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          ...
          <p className="animate-fade-in-up anim-delay-600 mx-auto mt-8 max-w-xl text-base font-light leading-[1.8] text-taupe opacity-0 sm:text-lg">
          ...
          <div className="animate-fade-in-up anim-delay-800 mt-14 flex flex-col items-center gap-4 opacity-0 sm:flex-row sm:justify-center">
            <Link
              ...
              className="inline-flex items-center gap-3 rounded-full border border-ink-warm/20 px-8 py-3.5 text-[12px] font-light tracking-[0.15em] text-ink-warm transition-all duration-500 hover:border-ink-warm/40 hover:bg-ink-warm hover:text-white"
            >
              Open the app
        ...
        <div className="animate-fade-in anim-delay-1200 absolute bottom-10 left-1/2 -translate-x-1/2 opacity-0">
          <div className="h-10 w-[1px] bg-gradient-to-b from-transparent via-black/20 to-transparent" />
        </div>
      </section>
      ...
      <section className="px-4 sm:px-8 py-28 sm:py-36">
        <ScrollReveal className="mx-auto max-w-2xl text-center">
          ...
          <Link
            href="/customer/explore"
            className="mt-10 inline-flex items-center gap-3 rounded-full border border-ink-warm/20 px-10 py-4 text-[13px] font-light tracking-[0.15em] text-ink-warm transition-all duration-500 hover:bg-[#ededed] hover:text-black"
          >
            Open the app
            <ArrowRight className="h-3.5 w-3.5" />
          </Link>
