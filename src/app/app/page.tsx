      ...
      <section className="flex min-h-screen items-center justify-center px-8 py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <Link
              href="/signup"
              className="text-[12px] font-light tracking-[0.15em] text-fog-300 transition-colors duration-500 hover:text-fog-100"
            >
              Set up your shop
            </Link>
          </div>
              ...
              <div className="device-float w-56 rounded-[2.5rem] border-2 border-white/10 bg-night-800 overflow-hidden" style={{ aspectRatio: "9/19" }}>
                ...
                <div className="flex items-center justify-between px-5 pt-3 pb-1">
                  ...
                  <div className="flex gap-1">
                    <div className="h-1 w-1 rounded-full bg-fog-500" />
                    <div className="h-1 w-1 rounded-full bg-fog-500" />
                    <div className="h-1 w-1 rounded-full bg-fog-500" />
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center px-4 pt-4 pb-4">
                  ...
                  />
                  <p className="mt-2 text-[9px] font-light tracking-[0.25em] text-fog-100">
                    SUNRISE BAKERY
                  </p>
                  {/* Deal */}
                  <div className="mt-3 w-full rounded-lg border border-white/10 px-3 py-2 text-center">
                    <p className="text-[9px] font-light text-fog-300">
                      Free coffee after 8 visits
                    </p>
                  </div>
                  {/* Toggle */}
                  <div className="mt-4 w-full">
                    <div className="mb-2 flex items-center justify-center gap-0.5 rounded-full border border-white/10 p-0.5">
                      <div className="flex-1 rounded-full bg-fog-100 py-1.5 text-center text-[8px] font-light tracking-[0.1em] text-black">
                        PHONE
                      </div>
                      <div className="flex-1 rounded-full py-1.5 text-center text-[8px] font-light tracking-[0.1em] text-fog-300">
                        EMAIL
                      </div>
                    </div>
                    <p className="mb-1 text-[8px] font-light tracking-[0.15em] text-fog-300">
                      PHONE NUMBER
                    </p>
                    <div className="w-full rounded-lg border border-white/10 bg-night-800 px-3 py-2.5 text-center">
                      <span className="text-[11px] font-light text-fog-100">
                        (555) 123-4567
                      </span>
                    </div>
                  </div>
                  {/* Button */}
                  <div className="mt-4 w-full rounded-full border border-ink-warm/20 py-2.5 text-center text-[8px] font-light tracking-[0.15em] text-fog-100">
                    CHECK IN
                  </div>
                </div>
              </div>
              <p className="text-[11px] font-light tracking-[0.2em] text-fog-300">
                JOIN
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={2} className="flex flex-col items-center gap-4">
              <div className="device-float w-56 rounded-[2.5rem] border-2 border-white/10 bg-night-800 overflow-hidden" style={{ aspectRatio: "9/19" }}>
                ...
                <div className="flex flex-col items-center px-4 pt-6 pb-4">
                  ...
                  <p className="mt-4 text-[10px] font-light tracking-[0.1em] text-fog-300">
                    6 of 8 visits · 2 to go
                  </p>
                  <p className="mt-2 text-[9px] font-light text-fog-300">
                    1 check-in per day
                  </p>
                </div>
              </div>
              ...
              <div className="device-float w-56 rounded-[2.5rem] border-2 border-white/10 bg-night-800 overflow-hidden" style={{ aspectRatio: "9/19" }}>
                ...
                <div className="flex flex-col px-4 pt-4 pb-4">
                  <div className="flex items-center gap-2">
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-night-700">
                      <span className="text-[9px] font-light text-fog-300">S</span>
                    </div>
                    <p className="text-[9px] font-light tracking-[0.15em] text-fog-100">
                      SUNRISE BAKERY
                    </p>
                    <span className="ml-auto rounded-full bg-fog-100 px-2 py-0.5 text-[7px] font-semibold uppercase tracking-[0.15em] text-black">
                      Verified visit
                    </span>
                  </div>
                  <FadeImage
                  ...
                  />
                  <p className="mt-3 text-[9px] font-light leading-relaxed text-fog-300">
                    Best sourdough in the neighborhood. Go early — it sells out.
                  </p>
                  <div className="mt-3 flex items-center gap-2 text-[8px] font-light text-fog-300">
                    <span>12 likes</span>
                    <span>·</span>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <ScrollReveal delay={2} className="mt-14">
            <div className="rounded-2xl border border-white/10 bg-night-800 p-6 sm:p-8">
              <p className="mb-6 text-[10px] font-light tracking-[0.3em] text-fog-100">
                NEARBY PLACES
              </p>
              <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
                {shops.map((shop) => (
                  ...
                  >
                    ...
                    />
                    <p className="mt-3 text-[11px] font-light tracking-[0.15em] text-fog-100">
                      {shop.name}
                    </p>
                    <p className="mt-2 text-[10px] font-light leading-relaxed text-fog-300">
                      Local favorite &middot; nearby
                    </p>
                    <div className="mt-4 rounded-full bg-fog-100 py-1.5 text-center text-[9px] font-semibold tracking-[0.1em] text-black">
                      VERIFIED VISITS
                    </div>
                  </div>
                ))}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <p className="text-[11px] font-medium tracking-[0.05em] text-fog-100">
                          Ventzon
                        </p>
                        <p className="text-[10px] font-light text-fog-300">
                          now
                        </p>
                      </div>
                      <p className="mt-1 text-[13px] font-light leading-[1.6] text-fog-300">
