  ...
  return (
    <main className="min-h-screen bg-night-950 px-6 pb-20 pt-28 text-fog-100">
      <div className="mx-auto w-full max-w-3xl">
        ...
        {/* Back link */}
        <div className="mt-14 border-t border-night-700 pt-8">
          <Link
            href="/"
