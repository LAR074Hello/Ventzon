...
export async function GET() {
  try {
    ...
    // Commission this month — flat 50%: $150 in month one (annual signup), then $15/mo.
    ...
    // All-time commission estimate — month one pays the $150 signup commission, then $15/mo
    ...
    for (const shop of activePro) {
      ...
      allTimeCommission += monthsActive === 1 ? SIGNUP_COMMISSION : SIGNUP_COMMISSION + (monthsActive - 1) * RECURRING_COMMISSION;
    }
