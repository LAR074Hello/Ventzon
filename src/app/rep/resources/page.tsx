...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "\"How much does it cost?\"", a: "$25/month — or $250/year if they want to save $50. Flat — no per-redemption fees." },
  ...
  return (
    <div className="min-h-full bg-black">
      <div className="px-5 pb-4" style={{ paddingTop: "calc(env(safe-area-inset-top, 20px) + 20px)" }}>
        <h1 className="text-[22px] font-light text-[#ededed]">Resources</h1>
