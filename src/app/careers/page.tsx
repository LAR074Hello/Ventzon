    ...
    <main className="min-h-screen bg-black text-[#ededed]">
      ...
      <section className="px-8 pb-20 pt-40">
        <div className="mx-auto max-w-3xl">
          <p className="text-[11px] font-light tracking-[0.4em] text-[#555]">CAREERS</p>
          <h1 className="mt-5 text-4xl font-extralight tracking-[-0.02em] text-[#ededed] sm:text-5xl">
            Build something<br />that matters.
          </h1>
          <p className="mt-6 max-w-xl text-[15px] font-light leading-relaxed text-[#666]">
      ...
      <section className="px-8 py-20">
        <div className="mx-auto max-w-3xl">
          <p className="text-[11px] font-light tracking-[0.4em] text-[#555]">OPEN POSITIONS</p>
          <h2 className="mt-4 text-[22px] font-extralight text-[#ededed]">1 opening right now</h2>

          {/* Job card */}
          <div className="mt-10 rounded-2xl border border-[#1a1a1a] bg-[#080808] p-8">
            {/* Header */}
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <div className="flex items-center gap-2.5">
                  <span className="rounded-full border border-emerald-900/40 bg-emerald-950/20 px-2.5 py-1 text-[10px] font-light tracking-[0.15em] text-emerald-400/80">
                    HIRING
                  </span>
                  <span className="text-[10px] font-light tracking-[0.15em] text-[#444]">INTERNSHIP</span>
                </div>
                <h3 className="mt-3 text-[24px] font-extralight text-[#ededed]">Summer Sales Intern</h3>
                <div className="mt-2 flex flex-wrap items-center gap-4">
                  <span className="flex items-center gap-1.5 text-[12px] font-light text-[#555]">
            ...
            <div className="mt-8 border-t border-[#111] pt-8 space-y-8">

              {/* About the role */}
              <div>
                <p className="text-[11px] font-light tracking-[0.3em] text-[#555]">ABOUT THE ROLE</p>
                <p className="mt-4 text-[14px] font-light leading-relaxed text-[#888]">
              ...
              {/* What you'll do */}
              <div>
                <p className="text-[11px] font-light tracking-[0.3em] text-[#555]">WHAT YOU'LL DO</p>
                <ul className="mt-4 space-y-2.5">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-[14px] font-light text-[#888]">
                      <span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-[#444]" />
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                <p className="text-[11px] font-light tracking-[0.3em] text-[#555]">WHAT WE'RE LOOKING FOR</p>
                <ul className="mt-4 space-y-2.5">
                  {[
              ...
              {/* Compensation */}
              <div>
                <p className="text-[11px] font-light tracking-[0.3em] text-[#555]">COMPENSATION</p>
                <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
                  {[
                    ...
                    <div key={label} className="rounded-xl border border-[#111] p-4">
                      <p className="text-[18px] font-extralight text-[#ededed]">{label}</p>
                      <p className="mt-1 text-[12px] font-light text-[#555]">{detail}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* CTA */}
              <div className="rounded-xl border border-[#1a1a1a] bg-[#050505] p-6 text-center">
                <p className="text-[15px] font-extralight text-[#ededed]">Ready to apply?</p>
                <p className="mt-2 text-[13px] font-light text-[#555]">
                  Send a short note about yourself — no resume required to get started.
                </p>
                <Link
                ...
                >
                  Email us to apply <ArrowRight className="h-3.5 w-3.5" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="px-8 pb-24">
        <div className="mx-auto max-w-3xl">
          <div className="border-t border-[#111] pt-16">
            <p className="text-[11px] font-light tracking-[0.4em] text-[#555]">WHY VENTZON</p>
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
              {perks.map(({ icon: Icon, label, detail }) => (
                <div key={label} className="flex items-start gap-4 rounded-xl border border-[#111] p-5">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#1a1a1a]">
                    <Icon className="h-3.5 w-3.5 text-[#555]" />
                  </div>
                  <div>
                    <p className="text-[14px] font-light text-[#ededed]">{label}</p>
                    <p className="mt-0.5 text-[12px] font-light text-[#555]">{detail}</p>
                  </div>
                </div>
              ))}
            </div>
