          ...
          <div className="mt-10 rounded-2xl border border-night-600 bg-night-900 p-8">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <Link
                ...
                className="inline-flex shrink-0 items-center gap-2.5 rounded-full border border-fog-100 px-6 py-3 text-[12px] font-light tracking-[0.15em] text-fog-100 transition-all duration-300 hover:bg-fog-100 hover:text-black"
              >
            ...
            <div className="mt-8 space-y-8 border-t border-[#222] pt-8">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2.5">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-[14px] font-light text-fog-200">
              ...
              <div className="rounded-xl border border-night-600 bg-[#060606] p-6 text-center">
                ...
                <Link
                  ...
                  className="mt-5 inline-flex items-center gap-2.5 rounded-full border border-fog-100 px-8 py-3.5 text-[12px] font-light tracking-[0.15em] text-fog-100 transition-all duration-300 hover:bg-fog-100 hover:text-black"
                >
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
              {perks.map(({ icon: Icon, label, detail }) => (
                <div key={label} className="flex items-start gap-4 rounded-xl border border-[#222] p-5">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-night-600">
                    <Icon className="h-3.5 w-3.5 text-fog-300" />
                  </div>
                  <div>
                    <p className="text-[14px] font-light text-fog-100">{label}</p>
